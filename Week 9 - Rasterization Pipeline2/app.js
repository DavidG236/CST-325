...
function createScene() {
    ...
    groundGeometry.worldMatrix.makeTranslation(0,-1,-10).multiply(new Matrix4().makeScale(10,10,10)).multiply(new Matrix4().makeRotationX(90));
...
function updateAndRender() {
    ...
    var trig = Math.sqrt(Math.sin(time.secondsElapsedSinceStart));
    ...
    gl.uniform4f(colorProgram.uniforms.colorUniform, Math.sin(trig), 1-trig, 1+trig, 1.0);
