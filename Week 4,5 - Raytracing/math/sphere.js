  ...
  Sphere.prototype = {
    ...
    raycast: function(r1) {
      ...
      if (discriminant < 0)
      {
        ...
        var distance = Math.min(result1,result2);
        
        if(result1<result2){
          var result={
              hit: true,
              point: r1.direction.clone().multiplyScalar(result1).add(r1.origin),
              normal: r1.direction.clone().multiplyScalar(result1).add(r1.origin).subtract(this.center).normalize(),
          ...
          var result={
            hit: true,
            point: r1.direction.clone().multiplyScalar(result2).add(r1.origin),
            normal: r1.direction.clone().multiplyScalar(result2).add(r1.origin).subtract(this.center).normalize(),
            distanceSquared: distance * distance
          }
