...
var lightDirection = new Vector3(5, 3, 0, 0);
...
function updateAndRender() {
    ...
    var yaw = new Matrix4().makeRotationY(0);
    var pitch = new Matrix4().makeRotationX(-45);

    // todo #10
    // add keyboard controls for changing light direction here

    // if(appInput == this.right){
    //     ulightDirection = yaw-lightDirection;
    // }
